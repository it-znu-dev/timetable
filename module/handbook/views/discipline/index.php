        ...
        'columns' => [
            ...
            [
               ...
               'value' => function($data){
                    ...
                    $btn .= '<a href="/web/index.php?r=handbook/discipline/delete&amp;id='.$data->discipline_distribution_id.'" title="Видалити" data-confirm="Are you sure you want to delete this item?" data-method="post"><span class="glyphicon glyphicon-trash"></span></a>';
                    return $btn;
               }
            ]
